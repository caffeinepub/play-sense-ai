...
export class Backend implements backendInterface {
    ...
    async canUploadImage(arg0: SessionId): Promise<UploadResult> {
        if (this.processError) {
            try {
                const result = await this.actor.canUploadImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRatingStats(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getRatingStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordImageUpload(arg0: SessionId): Promise<UploadResult> {
        if (this.processError) {
            try {
                const result = await this.actor.recordImageUpload(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordSubscription(arg0: SessionId, arg1: PlanName): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordSubscription(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRating(arg0: SessionId, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
